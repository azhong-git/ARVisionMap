...
public class TransparentTextureShaderProgram extends Program {
	...
	public TransparentTextureShaderProgram(Context context) {
		super(context, R.raw.texture_vertex_shader, R.raw.transparent_texture_fragment_shader);
